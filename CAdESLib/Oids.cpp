...
namespace
{
    ...
    OidInfo oidTable[] =
    {
        ...
        { { 0x2b, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x15, 0x02, 0x00, 0x00, 0x09 }, id_microsoft_certsrvPrevHash, "microsoft_certsrvPrevHash" },
        { { 0x2b, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x15, 0x04, 0x00, 0x00, 0x09 }, id_microsoft_certsrvnNextPublish, "microsoft_certsrvnNextPublish" },
        { { 0x2b, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x15, 0x07, 0x00, 0x00, 0x09 }, id_microsoft_certTemplate, "microsoft_certTemplate" },
        { { 0x2b, 0x06, 0x01, 0x04, 0x01, 0x82, 0x37, 0x15, 0x0a, 0x00, 0x00, 0x09 }, id_microsoft_appCertPolicies, "microsoft_appCertPolicies" },
