...
namespace CAdES {
    ...
    inline NewDataSet::NewDataSet() {
        this->BeginInit();
        this->InitClass();
        ::System::ComponentModel::CollectionChangeEventHandler^  schemaChangedHandler = gcnew ::System::ComponentModel::CollectionChangeEventHandler(this, &CAdES::NewDataSet::SchemaChanged);
    ...
    inline NewDataSet::NewDataSet(::System::Runtime::Serialization::SerializationInfo^  info, ::System::Runtime::Serialization::StreamingContext context) : 
        ...
        if (this->IsBinarySerialized(info, context) == true) {
            this->InitVars(false);
            ::System::ComponentModel::CollectionChangeEventHandler^  schemaChangedHandler1 = gcnew ::System::ComponentModel::CollectionChangeEventHandler(this, &CAdES::NewDataSet::SchemaChanged);
    ...
    inline ::System::Data::DataSet^  NewDataSet::Clone() {
        CAdES::NewDataSet^  cln = (cli::safe_cast<CAdES::NewDataSet^  >(__super::Clone()));
        cln->InitVars();
    ...
    inline ::System::Void NewDataSet::InitClass() {
        ...
        this->Prefix = L"";
        this->Namespace = L"http://tempuri.org/XMLSchema.xsd";
    ...
    inline ::System::Xml::Schema::XmlSchemaComplexType^  NewDataSet::GetTypedDataSetSchema(::System::Xml::Schema::XmlSchemaSet^  xs) {
        CAdES::NewDataSet^  ds = (gcnew CAdES::NewDataSet());
